...
REM -Dhttp.proxyHost=webproxy -Dhttp.proxyPort=80 -Dhttps.proxyHost=webproxy -Dhttps.proxyPort=80 -Dhttp.proxyUserName="myusername" -Dhttp.proxyPassword="mypassword"  
