#file : InMoov2.full2.pyntitled.1.py
...
#i01.mouthControl.setmouth(6,30)
# tweaking right hand
i01.rightHand.thumb.map(0,180,30,170)
...
# tweaking left hand
i01.leftHand.thumb.map(0,180,35,160)
i01.leftHand.index.map(0,180,35,160)
i01.leftHand.majeure.map(0,180,38,150)
...
i01.eyesTracking.ypid.setPID(18.0,5.0,0.1)
############################################################
...
ear.addCommand("search humans", "i01.headTracking", "findFace")
ear.addCommand("quit search", "i01.headTracking", "stopScan")
ear.addCommand("track", "i01.headTracking", "startTracking")
ear.addCommand("freeze track", "i01.headTracking", "stopTracking")
