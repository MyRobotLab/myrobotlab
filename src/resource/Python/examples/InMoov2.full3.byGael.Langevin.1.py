...
i01.head.jaw.setMinMax(76,103)
i01.mouthControl.setmouth(76,100)
helvar = 1
##############
i01.startEar()
##############
...
ear.startListening("sorry | how do you do | hello | byebye | i love you | thanks | thank you | nice")
