angular.module('mrlapp.service.WebkitSpeechRecognitionGui', [])
    ...
    $scope.lang = {
    		availableOptions: [
    		                   ...
    		                   {name:'Español - Argentina',         id:'es-AR'},
    		                   {name:'Español - Bolivia',      id:'es-BO'},
    		                   {name:'Español - Chile',      id:'es-CL'},
    		                   {name:'Español - Colombia',      id:'es-CO'},
    		                   {name:'Español - Costa Rica',      id:'es-CR'},
    		                   {name:'Español - Ecuador',      id:'es-EC'},
    		                   {name:'Español - El Salvador',      id:'es-SV'},
    		                   {name:'Español - España',      id:'es-ES', },
    		                   {name:'Español - Estados Unidos',      id:'es-US'},
    		                   {name:'Español - Guatemala',      id:'es-GT'},
    		                   {name:'Español - Honduras',      id:'es-HN'},
    		                   {name:'Español - México',      id:'es-MX'},
    		                   {name:'Español - Nicaragua',      id:'es-NI'},
    		                   {name:'Español - Panamá',      id:'es-PA'},
    		                   {name:'Español - Paraguay',      id:'es-PY'},
    		                   {name:'Español - Perú',      id:'es-PE'},
    		                   {name:'Español - Puerto Rico',      id:'es-PR'},
    		                   {name:'Español - República Dominicana',      id:'es-DO'},
    		                   {name:'Español - Uruguay',      id:'es-UY'},
    		                   {name:'Español - Venezuela',      id:'es-VE'},
    		                   {name:'Euskara',         id:'eu-ES'},
    		                   {name:'Filipino',        id:'fil-PH'},
    		                   {name:'Français',        id:'fr-FR'},
    		                   {name:'Galego',          id:'gl-ES'},
    		                   {name:'Hrvatski',        id:'hr_HR'},
    		                   {name:'IsiZulu',         id:'zu-ZA'},
    		                   {name:'Íslenska',        id:'is-IS'},
    		                   {name:'Italiano - Italia',        id:'it-IT'},
    		                   {name:'Italiano - Svizzera',     id:'it-CH'},
    		                   {name:'Lietuvių',        id:'lt-LT'},
    		                   ...
    		                   {name:'Slovenščina',     id:'sl-SI'},
    		                   {name:'Slovenčina',      id:'sk-SK'},
    		                   {name:'Suomi',           id:'fi-FI'},
    		                   {name:'Svenska',         id:'sv-SE'},
    		                   {name:'Tiếng Việt',      id:'vi-VN'},
    		                   {name:'Türkçe',          id:'tr-TR'},
    		                   {name:'Ελληνικά',        id:'el-GR'},
    		                   {name:'български',       id:'bg-BG'},
    		                   {name:'Pусский',         id:'ru-RU'},
    		                   {name:'Српски',          id:'sr-RS'},
    		                   {name:'Українська',      id:'uk-UA'},
    		                   {name:'한국어',         id:'ko-KR'},
    		                   {name:'中文 - 普通话 (中国大陆)',           id:'cmn-Hans-CN'},
    		                   {name:'中文 - 普通话 (香港)',          id:'cmn-Hans-HK'},
    		                   {name:'中文 - 中文 (台灣)',          id:'cmn-Hant-TW'},
    		                   {name:'中文 - 粵語 (香港)',          id:'yue-Hant-HK'},
    		                   {name:'日本語',           id:'ja-JP'},
    		                   {name:'हिन्दी',            id:'hi-IN'},
    		                   {name:'ภาษาไทย',         id:'th-TH'}    		                   
    		],
    		selectedOption: {id: 'en-US', name:"English - United States"}    
    };
