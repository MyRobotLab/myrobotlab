...
public class StringUtil {
   ...
   * @param random
   *          generator for random index within String
   * @return random char
   */
   ...
   * 
   * Note: These Strings have only a limited set of characters but these are
   * from various parts of the Unicode space.
   * 
   * @param random
   *          generator used for character retrieval
   * @return random char
   */
   ...
   * 
   * When creating an byte array out of the String it will have a size of
   * {@code length}.
   * 
   * @param length
   *          maximum size of resulting byte array
  ...
  /**
   * Creates a byte array from a random String containing some Unicode
   * characters.
   * 
   * The resulting byte array will have a size of {@code length} +1 since
