 ...
 * 
 * Use this to generate a configuration
 * Use this to load a configurtion.
 * Uncomment the @Test annotation to run the desired test method. 
 * 
 * SimpleConfig is defined as an arduino connected to COM5, with
 * a servo attached to pin 7 with an initial position of 90 degrees.
 * 
 * InMoov2Config is a genereated config based on loading the current
 * InMoov2.py scripts then having runtime save the configs.
 * 
 * @author kwatters
 *
 */
...
//    Runtime.createAndStart("webgui", "WebGui");
 ...
 // @Test
  public void generateInMoov2Configs() throws Exception {
    ...
    // if you start mary with jdk11 it will fail because of some lame string/float parsing logic in marytts
