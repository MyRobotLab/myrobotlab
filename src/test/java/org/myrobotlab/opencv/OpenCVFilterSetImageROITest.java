...
public class OpenCVFilterSetImageROITest  extends AbstractOpenCVFilterTest {
  ...
  public OpenCVFilter createFilter() {
    ...
    OpenCVFilter f = new OpenCVFilterSetImageROI();
    Assert.notNull(f.name);
    f.release();
    // Ok, return the named constructor one.
    return new OpenCVFilterSetImageROI("filter");
  }
