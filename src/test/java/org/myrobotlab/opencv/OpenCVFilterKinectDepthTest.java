...
public class OpenCVFilterKinectDepthTest  extends AbstractOpenCVFilterTest {
  ...
  public OpenCVFilter createFilter() {
    ...
    OpenCVFilter f = new OpenCVFilterKinectDepth();
    Assert.notNull(f.name);
    f.release();
    // Ok, return the named constructor one.
    return new OpenCVFilterKinectDepth("filter");
  }
