...
public class OpenCVFilterKinectDepthMaskTest  extends AbstractOpenCVFilterTest {
  ...
  public OpenCVFilter createFilter() {
    ...
    OpenCVFilter f = new OpenCVFilterKinectDepthMask();
    Assert.notNull(f.name);
    f.release();
    // Ok, return the named constructor one.
    return new OpenCVFilterKinectDepthMask("filter");
  }
