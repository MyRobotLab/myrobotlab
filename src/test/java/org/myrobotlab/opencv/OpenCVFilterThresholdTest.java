...
public class OpenCVFilterThresholdTest  extends AbstractOpenCVFilterTest {
  ...
  public OpenCVFilter createFilter() {
    ...
    OpenCVFilter f = new OpenCVFilterThreshold();
    Assert.notNull(f.name);
    f.release();
    // Ok, return the named constructor one.
    return new OpenCVFilterThreshold("filter");
  }
