...
public class OpenCVFilterGoodFeaturesToTrackTest  extends AbstractOpenCVFilterTest {
  ...
  public OpenCVFilter createFilter() {
    ...
    OpenCVFilter f = new OpenCVFilterGoodFeaturesToTrack();
    Assert.notNull(f.name);
    f.release();
    // Ok, return the named constructor one.
    return new OpenCVFilterGoodFeaturesToTrack("filter");
  }
