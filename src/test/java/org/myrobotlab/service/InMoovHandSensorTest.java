...
/**
 * A quick little scratch .. TODO: delete this before checking in and add a
 * proper unit test for this.
 * 
 * This starts an arduino / an inmoov hand and attaches the analog pin data from
 * A0 -A4 to flow through the hand.
 * 
 * @author kwatters
 *
 */
...
public class InMoovHandSensorTest {
  ...
  public void testHandSensor() throws Exception {
    ...
    Thread.sleep(1000);
    // ok.. now what?
    // the arduino is a pin array publisher... so we want to attach the inmoov
    // hand which is a pin array listener.
    ...
    ard.attachPinArrayListener((PinArrayListener) leftHand);
