...
public class AbstractTest {
  ...
  static public class ChaosMonkey extends Thread {
    public int id;
    public long startTs;
    ...
    public String toString() {
      ...
      String exception = (exceptionDeath == null) ? "" : Log.stackToString(exceptionDeath);
  ...
  public List<Exception> getReasonOfDeath() {
