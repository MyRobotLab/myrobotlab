...
public class PythonTest extends AbstractServiceTest {
  ...
  public void testService() throws Exception {
    ...
    clock.startClock();
    sleep(2000);
    Integer count = (Integer)python.getValue("count");
    assertTrue(count > 0);
