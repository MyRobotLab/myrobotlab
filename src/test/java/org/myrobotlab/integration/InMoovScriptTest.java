...
public class InMoovScriptTest extends AbstractTest {
  ...
  public static void setUpBeforeClass() throws Exception {
    ...
    // addScript("./src/main/resources/resource/InMoovEyelids/InMoovEyelids.py");
    // - these script don't even create a i01 which is the only check :P
  ...
  public void testInMoovScript() throws IOException {
    ...
    for (Script script : scripts) {
      // script = new
      // Script("./src/main/resources/resource/InMoovEyelids/InMoovEyelids.py",
      // FileIO.toString("./src/main/resources/resource/InMoovEyelids/InMoovEyelids.py"));
