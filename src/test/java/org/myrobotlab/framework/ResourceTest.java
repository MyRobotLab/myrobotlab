...
public class ResourceTest extends AbstractTest {
  ...
  public void test() throws InterruptedException, IOException {
    ...
    assertTrue(rs != null && (rs.contentEquals(s) &&
        rs.contentEquals(script) &&
        rs.contentEquals(resourceString) &&
        rs.contentEquals(strParams) &&
        rs.contentEquals(b) &&
        rs.contentEquals(bs) &&
        rs.contentEquals(serviceScript) &&
        rs.contentEquals(bstr)        
        ));
