...
public class ApiFactoryTest {
	...
	public void testProcessString() {
		try {
			 ...
			 * log.info("ret - {}", new String(bos.toByteArray())); List<ApiDescription>
			 * apis = (List<ApiDescription>)o; assertTrue(apis.size() > 1); retJson = new
			 * String(bos.toByteArray()); log.info("ret - {}", retJson);
			 */
