...
public class PeerDiscovery {
	 ...
	 * 
	 * @param group The identifier shared by the peers that will be discovered.
	 * @param port  a valid port, i.e.: in the range 1025 to 65535 inclusive
	 ...
	 * 
	 * @param timeout  How long to wait for responses, in milliseconds. Call will
