...
public abstract class BaseCache implements ManagedCache {
	...
	/*
	 * Get an float primitive value from the cache. Tests for: Float, Integer, Byte,
	 * Short, String (parseDouble)
	 * 
	 ...
	 * 
	 * @param value
	 * @param defaultDouble return value if the string cannot be parsed into an
	 *                      double
	 * @return
	 */
	...
	/**
	 * Internal method for BaseCache to actually remove items from the implementing
	 * cache.
	 * 
	 * @param name
	 */
