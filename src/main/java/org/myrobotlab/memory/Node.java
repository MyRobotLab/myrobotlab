...
public class Node implements Serializable {
	...
	/*
	 * the most important method get is the effective "search" method of memory. It
	 * has an XPath like syntax the "/" means "data of" a node, so when the path is
	 * /k1/k2/ - would mean get the hashmap of k2 /k1/k2 - means get the key value
	 * of k2 in the hashmap of k1
	 * 
