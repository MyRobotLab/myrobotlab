...
public class Memory {
	...
	public Object put(String parentPath, Node node) {
		...
		/*
		 * AUTOBUILD - WOULD BE NICE if (object == null && autoBuildPaths) { int pos0 =
		 * 0; int pos1 = parentPath.indexOf("/"); while (pos1 != -1) { String parentKey
		 * = parentPath.substring(pos0, pos1); pos0 = pos1; pos1 =
