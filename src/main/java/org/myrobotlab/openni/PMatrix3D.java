...
public final class PMatrix3D /* implements PMatrix3D , PConstants */ {
	...
	public void apply(float n00, float n01, float n02, float n03, float n10, float n11, float n12, float n13, float n20,
	...
	/*
	 * Copies the matrix contents into a 16 entry float array. If target is null (or
	...
	protected void invRotate(float angle, float v0, float v1, float v2) {
		...
		preApply((t * v0 * v0) + c, (t * v0 * v1) - (s * v2), (t * v0 * v2) + (s * v1), 0, (t * v0 * v1) + (s * v2),
	...
	public void set(PMatrix3D matrix) {
		...
		set(src.m00, src.m01, src.m02, src.m03, src.m10, src.m11, src.m12, src.m13, src.m20, src.m21, src.m22, src.m23,
				src.m30, src.m31, src.m32, src.m33);
	}

	/*
	 * static public String[] nfs(int num[], int digits) { String formatted[] = new
	 * String[num.length]; for (int i = 0; i < formatted.length; i++) { formatted[i]
	 * = nfs(num[i], digits, 5); } return formatted; }
	 * 
	 * 
