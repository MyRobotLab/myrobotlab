...
public class GeneticParameters {
  ...
  /**
   * @param geneticComputeSimulation
   *          the geneticComputeSimulation to set
   */
  ...
  /**
   * @param geneticPoolSize
   *          the geneticPoolSize to set
   */
  ...
  /**
   * @param geneticMutationRate
   *          the geneticMutationRate to set
   */
  ...
  /**
   * @param geneticRecombinationRate
   *          the geneticRecombinationRate to set
   */
  ...
  /**
   * @param geneticGeneration
   *          the geneticGeneration to set
   */
