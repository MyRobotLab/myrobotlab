...
public class Status implements Serializable {// extends Exception {
	...
	/**
	 * for minimal amount of information error is assumed, and info is detail of an
	 * ERROR
	 * 
	 * @param detail d
	 */
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(name, status.name) && Objects.equals(level, status.level)
				&& Objects.equals(key, status.key) && Objects.equals(detail, status.detail);
	}
