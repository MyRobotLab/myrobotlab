 ...
 * 
 * This class will run a search against a solr instance (in myrobotlab) and provide a dataset iterator on the
 * results.  It's expected that the solr index has a field called "label" that contains the label for the document
 * in addition, it is also expected that the documents have a field called "bytes" that contains a binary image.
 * 
 */
