...
public class Pcf8574 extends Service implements I2CControl, PinArrayControl {
	 ...
	 */
	public List<String> deviceAddressList = Arrays.asList("0x20", "0x21", "0x22", "0x23", "0x24", "0x25", "0x26",
			"0x27", "0x38", "0x39", "0x3A", "0x3B", "0x3C", "0x3D", "0x3E", "0x3F", "0x49", "0x4A", "0x4B"); // Max9744
	// Addresses
	...
	public void write(Integer address, Integer value) {
		...
		if (pinDef.getMode() == "OUTPUT") {
			...
			log.error("Can't write to a pin in input mode. Change direction to OUTPUT ({}) with pinMode first.",
					OUTPUT);
		}
