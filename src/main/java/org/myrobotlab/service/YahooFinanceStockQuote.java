...
public class YahooFinanceStockQuote extends HttpClient {
	...
	public String fetchQuote(String ticker) throws ClientProtocolException, IOException, JSONException {
		...
		String askPrice = obj.getJSONObject("query").getJSONObject("results").getJSONObject("quote").get("Ask")
				.toString();
	...
	static public ServiceType getMetaData() {
		...
		meta.addDescription(
				"This service will query Yahoo Finance to get the current stock price.  more info @ https://developer.yahoo.com/yql/");
