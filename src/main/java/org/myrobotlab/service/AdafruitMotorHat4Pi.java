...
public class AdafruitMotorHat4Pi extends AbstractMotorController implements I2CControl {
	...
	public List<String> deviceAddressList = Arrays.asList("0x60", "0x61", "0x62", "0x63", "0x64", "0x65", "0x66",
			"0x67", "0x68", "0x69", "0x6A", "0x6B", "0x6C", "0x6D", "0x6E", "0x6F", "0x71", "0x72", "0x73", "0x74",
			"0x75", "0x76", "0x77", "0x78", "0x79", "0x7A", "0x7B", "0x7C", "0x7D", "0x7E", "0x7F");
	// Default address
	public String deviceAddress = "0x60";
	/**
	 * This address is to address all PCA9685 on the i2c bus. Don't use this address
	 * for any other device on the i2c bus since it will cause collisions.
	 */
	...
	/*
	 * Refresh the list of running services that can be selected in the GUI In this
	 * case only RasPi service can be selected
	 */
	...
	public void detach(Attachable service) {
		 ...
		 * detachMotorControl((MotorControl) service); } catch (Exception e) { // TODO
		 * Auto-generated catch block); log.error("setController / attach throw", e); }
		 * return; }
		 */
	}
