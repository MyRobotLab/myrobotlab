...
public class WatchDogTimer extends Service {
	...
	public class Timer implements Runnable {
		...
		public void reset() {
			...
			log.debug("reset checkpoint {}.{} to +{} ms {} ms remaining", getName(), name, interval,
	...
	public class CheckPointWorker implements Runnable {
		...
		/**
		 * interval to "send" a reset, reset includes how much to push (futureMs) the
		...
		public CheckPointWorker(WatchDogTimer parent, Integer checkPointIntervalMs, String watchDogTimerName,
				String checkPointName) {
	...
	/**
	 * named method to "check-in" - a service calls this function to say "everything
	 * is ok"
	 * 
	...
	/**
	 * named method to "check-in" - a service calls this function to say "everything
	 * is ok" the next time it will "check-in" is in future milliseconds
	 * 
	 * @param timerName
	 * @param future
	 * @return
	...
	public static void main(String[] args) {
		try {
			...
			}
			{
				...
				/*
				 * for (int i = 0; i < 100; ++i) { // "manual" checkpoints can be sent by
				 * specifying // the name of the timer... joystickCheck.checkPoint("watchdog");
