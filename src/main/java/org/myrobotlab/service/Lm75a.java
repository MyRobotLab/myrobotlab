...
public class Lm75a extends Service implements I2CControl {
	...
	public List<String> deviceAddressList = Arrays.asList("0x48", "0x49", "0x4A", "0x4B", "0x4C", "0x4D", "0x4E",
			"0x4F");
	...
	/**
	 * This method reads and returns the raw temperature as two bytes where the MSB
	 * is the integer part of the temperature ( + sign ) and the LSB is the
	...
	/**
	 * valid for a control or controller which can only have a single other service
	 * attached
	 * 
