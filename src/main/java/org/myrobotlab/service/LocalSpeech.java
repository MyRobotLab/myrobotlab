 ...
 *    <a href="https://www.lifewire.com/mac-say-command-with-talking-terminal-2260772">Mac Say command</a>
 * <p>
 * Linux possibilities
 * <a href="https://launchpad.net/ubuntu/precise/+source/svox/">SVox</a>
 * <p>
 * More Voices can be found for Windows at
 * <a href="https://www.microsoft.com/en-us/download/details.aspx?id=3971">TODO replace with non-404</a>
 * <p>
 ...
 * <p>
 * MBROLA voices -
 * <a href="https://github.com/espeak-ng/espeak-ng/blob/master/docs/mbrola.md#linux-installation">MBrola Linux Installation</a>
 *
 * @author moz4r
 */
public class LocalSpeech extends AbstractSpeechSynthesis {
    ...
    /**
     * The path to the Windows TTS executable.
     */
    protected String ttsPath = getResourceDir() + fs + "tts" + fs + "tts.exe";

    /**
     * The path to the Mimic 1 executable on Windows.
     */
    protected String mimicPath = getResourceDir() + fs + "mimic" + fs + "mimic.exe";

    /**
     * The final command to execute to generate a TTS audio file.
     */
    protected String ttsCommand = null;

    /**
     * Characters to filter out of the phrase to speak
     */
    protected String filterChars = "\"'\n";

    /**
     * Whether to remove the extension from the
     * generated audio file
     */
    protected boolean removeExt = false;

    /**
     * Windows tts.exe appends "0.mp3" to the filename,
     * enabling this boolean applies some workarounds to account
     * for such behavior.
     */
    ...
    /**
     * Set whether to remove the extension from
     * the generated audio file.
     *
     * @param b Whether to remove the extension
     * @see #removeExt
     */
    ...
    /**
     * Set whether to use the Windows TTS hack.
     *
     * @param b Whether to use the hack
     */
    ...
    /**
     * Set the TTS command template. The template can have the following
     * fields that will be replaced:
     * <ul>
     *     <li>{@code "{text}"}: The text to be spoken</li>
     *     <li>{@code "{filename}"}: The filename for the generated audio file</li>
     *     <li>{@code "{voice_name}"}: The voice selection in String form, such as {@code "francis"}</li>
     *     <li>{@code "{voice}}: The provider ID of the voice</li>
     * </ul>
     *
     * The primary and secondary voice selections are taken from
     * the {@link Voice#getName()} and {@link Voice#getVoiceProvider()} ()} respectively.
     * <p>
     * Most TTS engines only require a primary voice selection, some however require both
     * a primary and a secondary.
     *
     * @param ttsCommand The command template to use
     */
    ...
    /**
     * Get the characters to filter out
     *
     * @return The filter characters as a String
     */
    ...
    /**
     * Get the path to the Windows TTS executable.
     * @return The path to the TTS exe
     */
     ...
     *
     * @param ttsPath - full path to windows tts.exe executable TODO - override also
     *                other os
     */
