...
public class Mpr121 extends Service implements I2CControl, PinArrayControl {
	 ...
	 * measuring starting with ELE0 as number 1 Setting pins = 0 will stop measuring
	 */
	...
	int readRegister8(int reg) {
		...
		controller.i2cWriteRead(this, Integer.parseInt(deviceBus), Integer.decode(deviceAddress), writebuffer,
				writebuffer.length, readbuffer, readbuffer.length);
