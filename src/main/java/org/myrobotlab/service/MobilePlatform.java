...
public class MobilePlatform extends Service {
	 ...
	 * .html) was EXTREMELY helpful for someone (like me) who has never implemented
	 * a Pid controller.
	 * 
	 ...
	 * explanation http://en.wikipedia.org/wiki/Lead-lag_compensator - for lead/lag
	 * compensation http://brettbeauregard.com/blog/2011/04/improving-the
	 ...
	 * deltaHeading ~= error
	 * 
	 * offset already done will need a max power value - don't want it going at 100%
	 * power to get to anywhere (i think)
	 * 
	 ...
	 * 
	 * Turn = Kp*(error) + Ki*(integral) + Kd*(derivative) + the complexity of error
	 * being 1.5 second lag
	 */
