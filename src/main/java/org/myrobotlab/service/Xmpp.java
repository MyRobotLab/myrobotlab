 ...
 *
 */
public class Xmpp extends Service implements Gateway, ChatManagerListener, ChatMessageListener, MessageListener,
	...
	public static class Contact {
		...
		public String toString() {
			return String.format("user: %s, name: %s, presence: %s, type: %s, status: %s", user, name, type, presence,
					status);
		}
	}
	...
	public void presenceChanged(Presence presence) {
		...
		getContactList();
		/*
		 * if (contacts.containsKey(user)) { Contact c = contacts.get(user); c.presence
		 * = presence.toString(); invoke("publishPresenceChanged", c); }
		 */
	}
