...
public class DatabaseConnector extends AbstractConnector {
	...
	public void startCrawling() {
		...
		try {
			state = connection.createStatement(java.sql.ResultSet.TYPE_FORWARD_ONLY,
	...
	static public ServiceType getMetaData() {
		...
		meta.addDescription(
				"This service will run a select statement against a database and return the rows as documents to be published");
