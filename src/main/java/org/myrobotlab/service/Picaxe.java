...
// DigitalIO, AnalogIO, ServoController
{
	...
	public static void main(String[] args) throws Exception {
		 ...
		 * 
		 * fos = new FileOutputStream("test.backup"); out = new ObjectOutputStream(fos);
		 * out.writeObject(remote); out.writeObject(log); out.writeObject(PICAXE);
		 * out.writeObject(gui); out.close();
		 * 
		 * 
		 * log.startService();
		 * 
