...
public interface NeoPixelControl extends NameProvider {
	 ...
	 * @param controller c
	 * 
	 * @param numPixel   - All of the config needed for the device -numPixel=number
	 *                   of pixel of the neopixel hardware
	 * @param pin        p -
	 * @throws Exception e
	 */
	 ...
	 * red - value 0-255 - set base color for the animation &#64;param green - value
	 * 0-255 - set base color for the animation &#64;param blue - value 0-255 - set
	 * base color for the animation &#64;param speed - set speed of the animation 1
	 * = fastest (update every ~30ms), 100 = 100 times slower than 1 value </pre>
	 */
