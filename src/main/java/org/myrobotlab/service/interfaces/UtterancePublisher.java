...
/**
 * Utterance Publisher interface is an interface that publishes utterances.
 * An utterance is a piece of text that came from a user.  It might come from a chat
