...
public interface I2CController extends Attachable {
	 ...
	 * @return number of bytes read
	 *
	 *         IOException thrown in case byte cannot be read from the i2c device or
	 *         i2c bus
	 */
	int i2cWriteRead(I2CControl control, int busAddress, int deviceAddress, byte[] writeBuffer, int writeSize,
