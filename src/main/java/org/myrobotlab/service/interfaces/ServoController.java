...
public interface ServoController extends Attachable {
	...
	/**
	 * The one and only attach which is type specific and does all the work which we
	 * expect
	 * 
	...
	/**
	 * attach with parameters which will set attributes on ServoControl ??? rules on
	 * which attributes in which service can be changed ???
	 * 
	 * @param servo the servo
