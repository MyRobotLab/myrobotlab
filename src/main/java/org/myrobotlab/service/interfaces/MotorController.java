...
public interface MotorController extends Attachable {
	...
	/**
	 * 
	 * request for motor to move the motor can be queried for the new powerlevel and
	 * the controller shall appropriately change power level and direction if
	 * necessary
	 * 
	...
	/**
	 * method for resetting all the variables of a motor this will reset counters if
	 * the motor is a stepper and / or other variables for other sorts of motors
	 * 
