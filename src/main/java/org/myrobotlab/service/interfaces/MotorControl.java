...
public interface MotorControl extends NameProvider, RelativePositionControl, Attachable {
	 ...
	 * MotorControl & MotorControllers where the range can be guaranteed -1.0 --to--
	 * 1.0 it's MotorControllers job to change this if needed into specific values
	 * (not MotorControl's job)
	 * 
	...
	/**
	 * change the motors direction such that negative power levels become clockwise
	 * if previous levels were counter clockwise and positive power levels would
	 * become counter clockwise
	 * 
