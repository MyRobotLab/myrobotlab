...
public class InMoov2Config extends ServiceConfig {
  ...
  public Plan getDefault(Plan plan, String name) {
    ...
    chatBot.bots.add("resource/ProgramAB/sl-SI");
    chatBot.bots.add("resource/ProgramAB/ta-TA");
    chatBot.bots.add("resource/ProgramAB/tr-TR");

    Runtime runtime = Runtime.getInstance();
    String[] bots = new String[] { "cn-ZH", "en-US", "fi-FI", "hi-IN", "nl-NL", "pl-PL","ru-RU", "de-DE", "es-ES", "fr-FR", "it-IT", "pt-PT", "sl-SI", "ta-TA", "tr-TR" };
