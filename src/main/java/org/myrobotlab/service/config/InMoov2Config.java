...
public class InMoov2Config extends ServiceConfig {
    ...
    public Plan getDefault(Plan plan, String name) {
        ...
        rm = new RandomMessageConfig(name, "setLeftHandSpeed", 3000, 8000, 8.0, 25.0, 8.0, 25.0, 8.0, 25.0, 8.0, 25.0,
                8.0, 25.0, 8.0, 25.0);
        random.randomMessages.put(name + ".setLeftHandSpeed", rm);

        rm = new RandomMessageConfig(name, "setRightHandSpeed", 3000, 8000, 8.0, 25.0, 8.0, 25.0, 8.0, 25.0, 8.0, 25.0,
                8.0, 25.0, 8.0, 25.0);
