...
public class InMoov2TorsoConfig extends ServiceConfig {
  ...
  public String topStom;
  public String midStom;
  public String lowStom;
  ...
  public Plan getDefault(Plan plan, String name) {
    ...
    // default peer names
    topStom = name + ".topStom";
    midStom = name + ".midStom";
    lowStom = name + ".lowStom";

    addPeer(plan, name, "topStom", topStom, "Servo", "Top Stomach servo");
    addPeer(plan, name, "midStom", midStom, "Servo", "Mid Stomach servo");
    addPeer(plan, name, "lowStom", lowStom, "Servo", "Low Stomach servo");

    // build a config with all peer defaults
    ServoConfig topStom = (ServoConfig) plan.get(this.topStom);
    ...
    ServoConfig midStom = (ServoConfig) plan.get(this.midStom);
    ...
    ServoConfig lowStom = (ServoConfig) plan.get(this.lowStom);
