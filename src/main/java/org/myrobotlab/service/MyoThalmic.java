...
public class MyoThalmic extends Service implements DeviceListener, MyoDataListener, MyoDataPublisher {
	...
	/*
	 * @Override public void onArmSync(Myo myo, long timestamp, Arm arm, XDirection
	 * xDirection) { whichArm = arm; }
	 */
	 ...
	 * direction, WarmupState warmUpState) { log.info("onArmSync {}", arm); whichArm
