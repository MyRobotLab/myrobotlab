...
public class Sweety extends Service {
	 ...
	 * arrays. If one of these arrays is less or more than four numbers length , it
	 * doesn't will be changed.
	 */
	...
	public void setRightArm(int[] shoulder, int[] arm, int[] biceps, int[] elbow, int[] wrist) {
		int[][] valuesArray = new int[][] { shoulder, arm, biceps, elbow, wrist, rightShoulder, rightArm, rightBiceps,
	...
	public void setLefttArm(int[] shoulder, int[] arm, int[] biceps, int[] elbow, int[] wrist) {
		int[][] valuesArray = new int[][] { shoulder, arm, biceps, elbow, wrist, leftShoulder, leftArm, leftBiceps,
				leftElbow, leftWrist };
		valuesArray = changeArrayValues(valuesArray);
	...
	public void setLeftHand(int[] thumb, int[] index, int[] middle, int[] ring, int[] pinky) {
		int[][] valuesArray = new int[][] { thumb, index, middle, ring, pinky, leftThumb, leftIndex, leftMiddle,
				leftRing, leftPinky };
		valuesArray = changeArrayValues(valuesArray);
	...
	public void setRightHand(int[] thumb, int[] index, int[] middle, int[] ring, int[] pinky) {
		int[][] valuesArray = new int[][] { thumb, index, middle, ring, pinky, rightThumb, rightIndex, rightMiddle,
				rightRing, rightPinky };
		valuesArray = changeArrayValues(valuesArray);
	 ...
	 * @param wristAngle    w
	 */
	public void setRightArmPosition(double shoulderAngle, double armAngle, double bicepsAngle, double ElbowAngle,
			double wristAngle) {
	...
	/*
	 * Move the left arm . Use : setLeftArm(shoulder angle, arm angle, biceps angle,
	 * Elbow angle, Elbow angle,wrist angle) -1 mean "no change"
	 * 
	 * @param shoulderAngle s
	 * 
	 * @param armAngle a
	 ...
	 * @param wristAngle w
	 */
	public void setLeftArmPosition(double shoulderAngle, double armAngle, double bicepsAngle, double ElbowAngle,
			double wristAngle) {
	 ...
	 */
	public void setLeftHandPosition(double thumbAngle, double indexAngle, double middleAngle, double ringAngle,
			double pinkyAngle) {
		if (thumbAngle == -1) {
	 ...
	 * angle, ring angle, pinky angle) -1 mean "no change"
	 */
	public void setRightHandPosition(double thumbAngle, double indexAngle, double middleAngle, double ringAngle,
			double pinkyAngle) {
		if (thumbAngle == -1) {
	...
	public void posture(String pos) {
		if (pos == "rest") {
			...
			setRightArmPosition(rightShoulder[rest], rightArm[rest], rightBiceps[rest], rightElbow[rest],
					rightWrist[rest]);
			setLeftHandPosition(leftThumb[rest], leftIndex[rest], leftMiddle[rest], leftRing[rest], leftPinky[rest]);
			setRightHandPosition(rightThumb[rest], rightIndex[rest], rightMiddle[rest], rightRing[rest],
					rightPinky[rest]);
	...
	public String captureGesture(String gestureName) {
		...
		script.append(String.format("Sweety.setRightArmPosition(%d,%d,%d,%d,%d)\n", rightShoulderServo.getPos(),
				rightArmServo.getPos(), rightBicepsServo.getPos(), rightElbowServo.getPos(), rightWristServo.getPos()));
		script.append(indentSpace);
		script.append(String.format("Sweety.setLeftArmPosition(%d,%d,%d,%d,%d)\n", leftShoulderServo.getPos(),
				leftArmServo.getPos(), leftBicepsServo.getPos(), leftElbowServo.getPos(), leftWristServo.getPos()));
		script.append(indentSpace);
	 ...
	 * be constructed. It has description, categories, and dependencies definitions.
	 * 
