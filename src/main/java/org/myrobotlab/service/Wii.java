...
public class Wii extends Service implements WiimoteListener, SerialPortEventListener {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println(
					loops + " regular method calls:" + (System.currentTimeMillis() - start) + " milliseconds.");
			...
			System.out.println(loops + " reflective method calls without lookup:" + (System.currentTimeMillis() - start)
					+ " milliseconds.");
			...
			System.out.println(loops + " reflective method calls with lookup:" + (System.currentTimeMillis() - start)
					+ " milliseconds.");
			...
			/*
			 * Arduino.addPortName("wiicom", CommPortIdentifier.PORT_SERIAL, (CommDriver)
			 * new WiiDriver(wii));
			 */
			/*
