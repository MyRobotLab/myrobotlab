...
public class Mqtt extends Service implements MqttCallback, IMqttActionListener {
	...
	/**
	 * not sure what this is supposed to be - perhaps a back-end id to identify the
	 * transaction on the listener
	 */
	...
	public void messageArrived(String topic, MqttMessage message) throws MqttException {
		...
		String messageStr = "onMqttMsg Time: " + time + "\tTopic: " + topic + "\tMessage: " + payload + "\tQoS: "
				+ message.getQos();
		log.info(messageStr);
