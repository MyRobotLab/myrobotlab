...
/**
 * Motor - MotorController which uses a "Port". Examples are Adafruit Motor Controller which uses ports M1 M2 M3 M4 Sabertooth has
 * M1 &amp; M2 ports.
 * 
 * @author GroG
 * 
 *         Some ports are labeled by numbers some by string values, since a string value can handle either we use a String port.
 *
 */
