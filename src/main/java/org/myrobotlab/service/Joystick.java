...
public class Joystick extends Service {
	...
	public Map<String, Component> getComponents() {
		 ...
		 * 
		 * info("number of components: " + hardwareComponents.length); for (int i = 0; i
		 * < hardwareComponents.length; i++) { // v net.java.games.input.Component c =
		 * hardwareComponents[i]; Component c = hardwareComponents[i]; String id =
		 * c.getIdentifier().toString(); // v Component component = new
		 * Component(getName(), i, c); // v log.info("found {}", component); // v
	...
	public List<Controller> getControllerList() {
		...
		net.java.games.input.Controller[] jinputControllers = ControllerEnvironment.getDefaultEnvironment()
				.getControllers();
	...
	/*
	 * Map<String, Set<RelativePositionControl>> axisConsumers = new HashMap<String,
	 * Set<RelativePositionControl>>();
	 * 
