...
public class Emoji extends Service implements TextListener {
	...
	public void display(String value) {
		...
		display.displayFullScreen(
				"https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/apple/129/rolling-on-the-floor-laughing_1f923.png");
	...
	public void cacheEmojis() throws IOException {
		...
		for (Element srcLink : media) {
			...
			if (tag.equals("img")) {
				...
				print(" * %s: <%s> %sx%s (%s)", tag, srcLink.attr("abs:src"), srcLink.attr("width"),
						srcLink.attr("height"), trim(srcLink.attr("alt"), 20));
			} else {
