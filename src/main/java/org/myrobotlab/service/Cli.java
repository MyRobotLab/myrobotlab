...
public class Cli extends Service {
	...
	/**
	 * pipes from other processes - possibly added by the Agent service our stdin is
	 * attached to a pipe and when we attach to that service our stdin becomes that
	 * processes std - and its stdout links to our stdout
	 */
	...
	public class Pipe implements Runnable {
		...
		/**
		 * attaches myOutputstream to the remote output stream relaying/piping the data
		 * back
		 * 
	...
	/**
	 * unfortunate collision of names :( this detach() does not detach from services
	 * - but detaches from the std i/o of another process
	 */
	public void detach() {
		try {
