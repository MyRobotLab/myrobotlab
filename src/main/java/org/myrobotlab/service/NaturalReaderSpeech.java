...
public class NaturalReaderSpeech extends AbstractSpeechSynthesis {
	...
	public static void main(String[] args) throws Exception {
		...
		reader.speakBlocking(String.format("my name is %s and i do believe I can speak?, yes, yes, i can",
				reader.getVoice().getName()));
	...
	public AudioData generateAudioData(AudioData audioData, String toSpeak) throws IOException {
		...
		String url = "http://api.naturalreaders.com/v4/tts/awsspeak?voiceId=" + voice.getVoiceProvider().toString()
				+ "&rate=" + rate + "&text=" + encoded + "&outputFormat=mp3";
