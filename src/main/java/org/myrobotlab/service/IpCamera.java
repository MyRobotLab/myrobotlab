...
public class IpCamera extends Service {
	 ...
	 * 
	 * URL url = new URL("http://" + host + "/get_status.cgi?user=" + user + "&pwd="
	 * + password); log.debug("getStatus " + url); URLConnection con =
	 ...
	 * else { } } catch (Exception e) { ret.append(e.getMessage()); logException(e);
	 * } return ret.toString(); }
	 */
	 ...
	 * 
	 * while ((inputLine = in.readLine()) != null) { ret.append(inputLine); }
	 * in.close(); } catch (Exception e) { logException(e); } return ret.toString();
	 * }
	 */
