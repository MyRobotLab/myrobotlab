...
public class AudioCapture extends Service {
	...
	public static void main(String[] args) throws InterruptedException {
		 ...
		 * format.getFrameSize() * 2, format.getFrameRate(), true); // big endian stream
		 ...
		 * 
		 * int numRead = 0; byte[] buf = new byte[line.getBufferSize()]; while ((numRead
		 * = stream.read(buf, 0, buf.length)) >= 0) { int offset = 0; while (offset <
		 * numRead) { offset += line.write(buf, offset, numRead - offset); } }
	...
	public void setAudioFormat(float sampleRate, int sampleSizeInBits, int channels, boolean signed,
			boolean bigEndian) {
