...
public class IntegratedMovement extends Service implements IKJointAnglePublisher {
	...
	public enum ObjectPointLocation {
		ORIGIN_CENTER(0x01, "Center Origin"), ORIGIN_SIDE(0x02, "Side Origin"), END_SIDE(0x04, "Side End"),
		END_CENTER(0x05, "Center End"), CLOSEST_POINT(0x06, "Closest Point"), CENTER(0x07, "Center"),
		CENTER_SIDE(0x08, "Side Center"), LEFT_SIDE(0x09, "Left Side"), RIGHT_SIDE(0x0A, "Right Side");
		public int value;
	...
	public enum Ai {
		HOLD_POSITION(0x01, "Hold Position"), AVOID_COLLISION(0x02, "Avoid Collision"),
	...
	public static void main(String[] args) throws Exception {
		...
		ik.visualize();
		((TestJmeIMModel) ik.jmeApp).addPart("ltorso", "Models/ltorso.j3o", 1, null, new Vector3f(0, 0, 0),
				Vector3f.UNIT_X.mult(1), (float) Math.toRadians(0));
		((TestJmeIMModel) ik.jmeApp).addPart("mtorso", "Models/mtorso.j3o", 1f, null, new Vector3f(0, 0, 0),
				Vector3f.UNIT_Y.mult(-1), (float) Math.toRadians(-90));
		((TestJmeIMModel) ik.jmeApp).addPart("ttorso", "Models/ttorso1.j3o", 1f, "mtorso", new Vector3f(0, 105f, 10),
				Vector3f.UNIT_Z, (float) Math.toRadians(-90));
		((TestJmeIMModel) ik.jmeApp).addPart("rightS", null, 1f, "ttorso", new Vector3f(0, 300f, 0), Vector3f.UNIT_Z,
				(float) Math.toRadians(0));
		((TestJmeIMModel) ik.jmeApp).addPart("Romoplate", "Models/Romoplate1.j3o", 1f, "rightS",
				new Vector3f(-143f, 0, -17), Vector3f.UNIT_Z.mult(-1), (float) Math.toRadians(-4));
		((TestJmeIMModel) ik.jmeApp).addPart("Rshoulder", "Models/Rshoulder1.j3o", 1f, "Romoplate",
				new Vector3f(-23, -45f, 0), Vector3f.UNIT_X.mult(-1), (float) Math.toRadians(-32));
		((TestJmeIMModel) ik.jmeApp).addPart("Rrotate", "Models/rotate1.j3o", 1f, "Rshoulder",
				new Vector3f(-57, -55, 8), Vector3f.UNIT_Y.mult(-1), (float) Math.toRadians(-90));
		((TestJmeIMModel) ik.jmeApp).addPart("Rbicep", "Models/Rbicep1.j3o", 1f, "Rrotate", new Vector3f(5, -225, -32),
				Vector3f.UNIT_X.mult(-1), (float) Math.toRadians(20));
		((TestJmeIMModel) ik.jmeApp).addPart("leftS", null, 1f, "ttorso", new Vector3f(0, 300f, 0), Vector3f.UNIT_Z,
				(float) Math.toRadians(0));
		((TestJmeIMModel) ik.jmeApp).addPart("omoplate", "Models/Lomoplate1.j3o", 1f, "leftS",
				new Vector3f(143f, 0, -15), Vector3f.UNIT_Z.mult(1), (float) Math.toRadians(-6));
		((TestJmeIMModel) ik.jmeApp).addPart("shoulder", "Models/Lshoulder.j3o", 1f, "omoplate",
				new Vector3f(17, -45f, 5), Vector3f.UNIT_X.mult(-1), (float) Math.toRadians(-30));
		((TestJmeIMModel) ik.jmeApp).addPart("rotate", "Models/rotate1.j3o", 1f, "shoulder", new Vector3f(65, -58, -3),
				Vector3f.UNIT_Y.mult(1), (float) Math.toRadians(-90));
		((TestJmeIMModel) ik.jmeApp).addPart("bicep", "Models/Lbicep.j3o", 1f, "rotate", new Vector3f(-14, -223, -28),
				Vector3f.UNIT_X.mult(-1), (float) Math.toRadians(17));
		((TestJmeIMModel) ik.jmeApp).addPart("Rwrist", "Models/RWristFinger.j3o", 1f, "Rbicep",
				new Vector3f(15, -290, -10), Vector3f.UNIT_Y.mult(-1), (float) Math.toRadians(180));
		((TestJmeIMModel) ik.jmeApp).addPart("wrist", "Models/LWristFinger.j3o", 1f, "bicep",
				new Vector3f(0, -290, -20), Vector3f.UNIT_Y.mult(1), (float) Math.toRadians(180));
		((TestJmeIMModel) ik.jmeApp).addPart("neck", "Models/neck.j3o", 1f, "ttorso", new Vector3f(0, 452.5f, -45),
				Vector3f.UNIT_X.mult(-1), (float) Math.toRadians(0));
		((TestJmeIMModel) ik.jmeApp).addPart("neckroll", null, 1f, "neck", new Vector3f(0, 0, 0),
				Vector3f.UNIT_Z.mult(1), (float) Math.toRadians(2));
		((TestJmeIMModel) ik.jmeApp).addPart("head", "Models/head.j3o", 1f, "neckroll", new Vector3f(0, 10, 20),
				Vector3f.UNIT_Y.mult(-1), (float) Math.toRadians(0));
		((TestJmeIMModel) ik.jmeApp).addPart("jaw", "Models/jaw.j3o", 1f, "head", new Vector3f(-5, 63, -50),
				Vector3f.UNIT_X.mult(-1), (float) Math.toRadians(0));
