...
public class Pid extends Service {
	...
	public static class PidData implements Serializable {
		...
		public String toString() {
			return String.format(
					"kp %f ki %f kd %f direction %d input %f output %f setpoint %f deadband %f outMin %f outMax %f", kp,
					ki, kd, controllerDirection, input, output, setpoint, deadband, outMin, outMax);
		}
	}
	 ...
	 * 
	 * @param key - named pid compute instance, so the Pid "service" can manage pid
	 *            systems
	 * @param min
	 * @param max
	 * 
	 ...
	 * @param key - named pid compute instance, so the Pid "service" can manage pid
	 *            systems
	 * @param Kp  - constant proportional value
	 * @param Ki  - constant integral value
	 * @param Kd  - constant derivative value
	 */
