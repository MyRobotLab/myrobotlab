 ...
 * device to make an SPI data transfer request. The result is the angular position of the encoder. The MrlAbstractEncoder converts
 * the 12 bits into a floating point value scaled from 0 to 360.
 * 
