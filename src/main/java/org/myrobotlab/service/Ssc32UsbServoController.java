...
public class Ssc32UsbServoController extends Service implements PortConnector, ServoController {
	 ...
	 * current Baud rate. 9600 (green) 38400 (red) 115200 (both green and red) Press
	 * the button to cycle through baud rates
	 */
	...
	/**
	 * Single parameter attach{type}({type}) - this is where the "real" attach logic
	 * is for this service.
	 */
	@Override
