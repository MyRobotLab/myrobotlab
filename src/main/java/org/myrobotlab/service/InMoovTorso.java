...
public class InMoovTorso extends Service {
	...
	public String getScript(String inMoovServiceName) {
		return String.format(Locale.ENGLISH, "%s.moveTorso(%.2f,%.2f,%.2f)\n", inMoovServiceName, topStom.getPos(),
				midStom.getPos(), lowStom.getPos());
	}
	...
	public void setLimits(int topStomMin, int topStomMax, int midStomMin, int midStomMax, int lowStomMin,
			int lowStomMax) {
	...
	public void setpins(Integer topStomPin, Integer midStomPin, Integer lowStomPin) {
		 ...
		 * 
		 * arduino.servoAttachPin(topStom, topStomPin); arduino.servoAttachPin(topStom,
		 * midStomPin); arduino.servoAttachPin(topStom, lowStomPin);
		 */
	}
	...
	public void test() {
		...
		/*
		 * FIXME - connections need to be outside .. this must be a ServoController if
