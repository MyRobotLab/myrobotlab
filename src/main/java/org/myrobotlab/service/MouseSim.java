...
public class MouseSim extends Service {
	 ...
	 * 
	 * @param keycode  buttoncode of button (use InputEvent.VK_XXX, where XXX is
	 *                 your button)
	 ...
	 * 
	 * @param keycode buttoncode of button (use InputEvent.VK_XXX, where XXX is your
	 *                button)
	 */
	 ...
	 * 
	 * @param keycode  array of buttoncodes of buttons (use InputEvent.VK_XXX, where
	 *                 XXX is your button)
	 * @param duration key press duration in milliseconds
	 */
	 ...
	 * 
	 * @param wheelAmt rotation amount, negative amounts rotate "backwards"
	 */
