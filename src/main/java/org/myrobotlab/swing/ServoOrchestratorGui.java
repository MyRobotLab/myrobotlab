...
public class ServoOrchestratorGui extends ServiceGui implements ActionListener, ItemListener, ListSelectionListener {
	...
	public ServoOrchestratorGui(final String boundServiceName, final SwingGui myService) {
		...
		JSplitPane splitpane_middlemiddle_middleleft = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT,
				middlemiddle_scrollpane, middleleft);
		...
		JSplitPane splitpane_middleright_middlemiddlemiddleleft = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT,
				middleright, middlemiddlemiddleleft);
		...
		JSplitPane splitpane_bottommiddleleft_bottommiddleright = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT,
				bottommiddleleft, bottommiddleright);
		...
		JSplitPane splitpane_bottommiddle_bottomright = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, bottommiddle,
				bottomright);
		...
		JSplitPane splitpane_bottomleft_bottommiddlebottomright = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT,
				bottomleft, bottommiddlebottomright);
