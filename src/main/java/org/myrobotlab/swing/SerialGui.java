...
public class SerialGui extends ServiceGui implements ActionListener, ItemListener {
	...
	/*
	 * the gui is no simplified - a single broadcastState() -&gt; onState(Serial) is
	 * used to propegate all data which needs updating. Since that is the case a
	 * single invokeLater is used. It is unadvised to have more invokeLater in other
	 * methods as race conditions are possible
	 */
