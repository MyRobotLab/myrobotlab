...
public class DockableTabPane implements ActionListener {
	 ...
	 * this is not useful in its serializable form so we maintain a 'custom' map of
	 * dockable tabs - this contains size and location info which is serializable
	 */
	transient JTabbedPane tabs = new JTabbedPane();

	/**
	 * a interface / callback to preserve location, dimensions, and other data of a
	 * desktop
	 */
