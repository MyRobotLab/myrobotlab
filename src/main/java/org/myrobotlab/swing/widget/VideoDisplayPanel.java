...
public class VideoDisplayPanel {
	...
	VideoDisplayPanel(String boundFilterName, VideoWidget parent, SwingGui myService, String boundServiceName,
			ImageIcon icon) {
	...
	public void displayFrame(SerializableImage img) {
		...
		if (parent.normalizedSize != null) {
			myIcon.setImage(
					img.getImage().getScaledInstance(parent.normalizedSize.width, parent.normalizedSize.height, 0));
		} else {
