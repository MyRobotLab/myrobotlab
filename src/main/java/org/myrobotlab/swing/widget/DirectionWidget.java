...
public class DirectionWidget extends JPanel implements KeyListener {
  ...
  public DirectionWidget() {
    ...
    btnNw.setIcon(new ImageIcon(DirectionWidget.class.getResource(Util.getRessourceDir() + "/arrow_up_left_grey.png")));
    btnNw.setPressedIcon(new ImageIcon(DirectionWidget.class.getResource(Util.getRessourceDir() + "/arrow_up_left_green.png")));
    ...
    btnN.setIcon(new ImageIcon(DirectionWidget.class.getResource(Util.getRessourceDir() + "/arrow_up_grey.png")));
    btnN.setPressedIcon(new ImageIcon(DirectionWidget.class.getResource(Util.getRessourceDir() + "/arrow_up_green.png")));
    ...
    btnNe.setIcon(new ImageIcon(DirectionWidget.class.getResource(Util.getRessourceDir() + "/arrow_up_right_grey.png")));
    btnNe.setPressedIcon(new ImageIcon(DirectionWidget.class.getResource(Util.getRessourceDir() + "/arrow_up_right_green.png")));
    ...
    btnW.setIcon(new ImageIcon(DirectionWidget.class.getResource(Util.getRessourceDir() + "/arrow_left_grey.png")));
    btnW.setPressedIcon(new ImageIcon(DirectionWidget.class.getResource(Util.getRessourceDir() + "/arrow_left_green.png")));
    ...
    btnStop = new JButton("");
    btnStop.setIcon(new ImageIcon(DirectionWidget.class.getResource(Util.getRessourceDir() + "/bullet_square_grey.png")));
    btnStop.setPressedIcon(new ImageIcon(DirectionWidget.class.getResource(Util.getRessourceDir() + "/bullet_square_green.png")));
    ...
    btnE.setIcon(new ImageIcon(DirectionWidget.class.getResource(Util.getRessourceDir() + "/arrow_right_grey.png")));
    btnE.setPressedIcon(new ImageIcon(DirectionWidget.class.getResource(Util.getRessourceDir() + "/arrow_right_green.png")));
    ...
    btnSw.setIcon(new ImageIcon(DirectionWidget.class.getResource(Util.getRessourceDir() + "/arrow_down_left_grey.png")));
    btnSw.setPressedIcon(new ImageIcon(DirectionWidget.class.getResource(Util.getRessourceDir() + "/arrow_down_left_green.png")));
    ...
    btnS.setIcon(new ImageIcon(DirectionWidget.class.getResource(Util.getRessourceDir() + "/arrow_down_grey.png")));
    btnS.setPressedIcon(new ImageIcon(DirectionWidget.class.getResource(Util.getRessourceDir() + "/arrow_down_green.png")));
    ...
    btnSe.setIcon(new ImageIcon(DirectionWidget.class.getResource(Util.getRessourceDir() + "/arrow_down_right_grey.png")));
    btnSe.setPressedIcon(new ImageIcon(DirectionWidget.class.getResource(Util.getRessourceDir() + "/arrow_down_right_green.png")));
