...
public class ImageButton extends JButton {
	...
	public ImageButton(Object parent, ImageIcon icon, ImageIcon rolloverIcon, ImageIcon activatedIcon, String tooltip,
			int type, ActionListener listener) {
		super();
	...
	public ImageButton(String serviceType, String name) {
		this(name, Util.getImageIcon(serviceType + "/" + name + ".png"),
