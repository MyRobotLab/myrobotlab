...
public class ServoOrchestratorGUI_middlemiddle_panel extends JPanel implements Transferable {
	 ...
	 * </p>
	 * <p>
	 * Note we could easily support more than one. For example, if supports text and
	 * drops to a JTextField, could return the label's text or any arbitrary text.
	 * </p>
	 */
	@Override
	 ...
	 * </p>
	 * <p>
	 * Returns supported DataFlavor. Again, we're only supporting this actual Object
	 * within the JVM.
	 * </p>
	 * <p>
