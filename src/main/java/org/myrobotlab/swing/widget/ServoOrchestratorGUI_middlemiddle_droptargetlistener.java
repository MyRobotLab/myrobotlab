		...
		if (posx == -1 && posy == -1) {
			...
			while (searchpos >= 0) {
				if (rootPanel.getDragAndDropPanelMain().panels[searchpos][posy] == null) {
					...
					start = Integer
							.parseInt(rootPanel.getDragAndDropPanelMain().panels[searchpos][posy].servo_goal.getText());
					break;
				}
			}
			if (start == -1) {
			...
			while (searchpos < rootPanel.getDragAndDropPanelMain().panels.length) {
				if (rootPanel.getDragAndDropPanelMain().panels[searchpos][posy] == null) {
					...
					int goal = Integer.parseInt(
							rootPanel.getDragAndDropPanelMain().panels[searchpos][posy].servo_start.getText());
			...
			while (searchpos >= 0) {
				if (rootPanel.getDragAndDropPanelMain().panels[searchpos][f2] == null) {
					...
					start2 = Integer
							.parseInt(rootPanel.getDragAndDropPanelMain().panels[searchpos][f2].servo_goal.getText());
					break;
				}
			}
