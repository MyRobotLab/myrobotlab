...
public class RoombaGui extends ServiceGui
		implements ListSelectionListener, ActionListener, ChangeListener, KeyListener {
	...
	void makeButtonPanel() {
		...
		buttonPanel.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createTitledBorder("Commands"),
	...
	void makeCtrlPanel() {
		...
		ctrlPanel.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createTitledBorder("Movement"),
				BorderFactory.createEmptyBorder(5, 5, 5, 5)));
	...
	void makeDisplayPanel() {
		...
		displayPanel.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createTitledBorder("Display"),
		...
		JScrollPane scrollPane = new JScrollPane(displayText, ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS,
	...
	void makeSelectPanel() {
		...
		selectPanel.setBorder(
				BorderFactory.createCompoundBorder(BorderFactory.createTitledBorder("Select Roomba Type & Port"),
						BorderFactory.createEmptyBorder(1, 1, 1, 1)));
	 ...
	 * 32-127: notenum == corresponding note played thru beeper velocity == duration
	 * in number of 1/64s of a second (e.g. 64==1second) notenum 24: notenum == main
	 * vacuum velocity == non-zero turns on, zero turns off notenum 25: blink LEDs,
	 * velcoity is color of Power LED notenum 28 &amp; 29: spin left &amp; spin
	 * right, velocity is speed
	 * 
	 */
	...
	/**
	 * setPorts is called by onState - which is called when the Arduino changes port
	 * state is NOT called by the SwingGui component
	 * 
	 * @param p FIXME - there should be a corresponding gui element for the
