...
public class Pcf8574Gui extends ServiceGui implements ActionListener {
	...
	public Pcf8574Gui(final String boundServiceName, final SwingGui myService) {
		 ...
		 * north.add(controllerLabel); north.add(controller); north.add(deviceBusLabel);
		 * north.add(deviceBusList); north.add(deviceAddressLabel);
		 * north.add(deviceAddressList); north.add(attachButton);
		 * 
		 */
