...
public abstract class AbstractSpeechSynthesisGui extends ServiceGui implements ActionListener, ChangeListener {
  ...
  JButton speakButton = new JButton(new ImageIcon(ImageIO.read(FileIO.class.getResource(Util.getRessourceDir() + "/Speech.png"))));

  ImageIcon readyOK = new ImageIcon(ImageIO.read(FileIO.class.getResource(Util.getRessourceDir() + "/green.png")));
  ImageIcon readyNOK = new ImageIcon(ImageIO.read(FileIO.class.getResource(Util.getRessourceDir() + "/red.png")));
