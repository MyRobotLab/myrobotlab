...
public abstract class AbstractSpeechSynthesisGui extends ServiceGui implements ActionListener, ChangeListener {
  ...
  JButton speakButton = new JButton(new ImageIcon(ImageIO.read(new File(Util.getResourceDir() + "/Speech.png"))));

  ImageIcon readyOK = new ImageIcon(ImageIO.read(new File(Util.getResourceDir() + "/green.png")));
  ImageIcon readyNOK = new ImageIcon(ImageIO.read(new File(Util.getResourceDir() + "/red.png")));
