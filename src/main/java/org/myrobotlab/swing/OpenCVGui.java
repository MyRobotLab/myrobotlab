...
public class OpenCVGui extends ServiceGui implements ListSelectionListener, VideoGUISource, ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (o == capture) {
			...
			/**
			 * <pre>
			 * ALL FRAME GRABBER LOGIC IS DONE IN OpenCV.getGrabber() !!! 1 place of chaotic
			 * logic to rule them all !
			 * 
			 * if (type != null && type.startsWith("OpenKinect") || type.equals("PS3Eye") ||
			 * type.equals("Sarxos") || type.equals("VideoInput")||
			 * type.equals("FlyCapture")) { // cuz these are all cameras ...
			 * log.warn("setting as camera as source"); send("setInputSource",
			 * OpenCV.INPUT_SOURCE_CAMERA); }
			 */
	...
	public OpenCVFilterGui addFilterToGui(OpenCVFilter filter) {
		...
		if (filtergui == null) {
			...
			filtergui =
					...
					(OpenCVFilterGui) Instantiator.getNewInstance(FILTER_PACKAGE_NAME + "DefaultGui", name,
	 ...
	 * changes.
	 * 
	 * The entire service is sent and it is this functions responsibility to update
	 * all of the gui components based on data elements and/or method of the
	 * service.
	 * 
