...
public interface Mapper {
	 ...
	 * appropriate mapping value e.g -1,1 => ?,? the minY & maxY are left null until
	 * a "merge" is done in the attach of the AbstractMotorController.
	 * 
	 * When a Sabertooth motor controller is "attached" to a MotorControl the merge
	 * produces -1,1 => -127, 127 which is appropriate.
	 * 
