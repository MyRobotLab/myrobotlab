...
public class Reflector {
	...
	/**
	 * Parse the Class out of the passed-in objects. If an object is null, null will
	 * be used.
	 * 
	 * @param params
	 * @return
	 ...
	 * for 2 reasons: (1) the primitive will be boxed in this case which means more
	 * overhead (2) if something fails a NULL is returned which results in an
