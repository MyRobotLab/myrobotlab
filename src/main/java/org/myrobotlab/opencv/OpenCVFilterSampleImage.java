...
public class OpenCVFilterSampleImage extends OpenCVFilter {
	 ...
	 * 128, 128, 128, 1 = grey = HSV 128 0 0 0, 128, 128, 1 = olive = HSV 128 255 30
	 * 0, 0, 128, 1 = maroon = HSV 128 255 0 128, 0, 128, 1 = purple = HSV 128 255
	 * 150 128, 0, 0, 1 = blue = HSV 128 255 150 (navy)
	 */
	...
	public IplImage process(IplImage image) {
		...
		/*
		 * cvDrawRect(image, p0, p1, fillColor, 2, 1, 0); fillColor = cvScalar(130.0,
		 * 40.0, 120.0, 1.0); cvDrawRect(image, new CvPoint(158,140), new
		 * CvPoint(220,160), fillColor, 2, 1, 0); fillColor = cvScalar(160.0, 140.0,
		 * 20.0, 1.0); cvDrawRect(image, new CvPoint(20,200), new CvPoint(40,230),
		 * fillColor, 2, 1, 0);
		 */
		return image;
	}
