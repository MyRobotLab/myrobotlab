...
// TODO: this file is largely just copied from javacv.
// It doesn't expose the VideoCapture(filename, apiPreference) constructor,
// so we've added that.  I promise to make a pull request for this change. -kw
/*
...
public class OpenCVFrameGrabber extends FrameGrabber {
    ...
    public OpenCVFrameGrabber(String filename, int apiPreference) {
      ...
      // for example   org.bytedeco.javacpp.opencv_videoio.CAP_GSTREAMER;
    }
