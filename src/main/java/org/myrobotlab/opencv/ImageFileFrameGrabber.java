...
public class ImageFileFrameGrabber extends FrameGrabber {
	...
	public Frame grab() {
		/*
		 * not needed as opencv can self regulat - or adjust fps try { // pause for the
		 * specified delay before loading the image. Thread.sleep(delay); } catch
		 * (InterruptedException e) {} // set the file path
		 * 
		 */
