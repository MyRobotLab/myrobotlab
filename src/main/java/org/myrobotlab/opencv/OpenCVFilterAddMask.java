...
public class OpenCVFilterAddMask extends OpenCVFilter {
	...
	public IplImage process(IplImage image) throws InterruptedException {
		if (mask != null) {
			...
			/*
			 * 
			 * cvSetImageROI(output, cvRect(0, 0, mask.width(), mask.height())); cvAdd(mask,
			 * mask, output); cvResetImageROI(overlay);
			 */
	...
	/*
	 * void overlayImage(final Mat background, final Mat foreground, Mat output, int
	 * posX, int posY){
	 * 
