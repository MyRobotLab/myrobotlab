...
public class OpenCVData implements Serializable {
	...
	/**
	 * all non-serializable data including frames an IplImages It will also contain
	 * a global source set of keys
	 */
	 ...
	 * 
	 * FIXME - logic to convert from selected or convert from input should probably
	 * NOT be here, but be controlled by the filters more directly
	 * 
	 * @return
	 */
	...
	/**
	 * the generalized getImage returns the 'latest' output - if that does not exist
	 * it return the original input - most other type converters should use this
	 * method
	 * 
	 * @return
	 */
	...
	/**
	 * pushes a reference to both images from a kinect grabber default "input" image
	 * is depth - but both can be accessed from any filter
	 * 
