...
public class OpenCVFilterUndistort extends OpenCVFilter {
	 ...
	 * https://github.com/opencv/opencv/blob/master/samples/cpp/calibration.cpp and
	 * CV docs here:
	 ...
	 * calibration matrix is already known and its hard coded! oops.. TODO: make it
	 * configurable.
	 */
	...
	public void initCameraAndDistortionMatrix() {
		...
		double[] cameraMatrixData = new double[] { 234.58254183078603, 0.0, 320.85112106077526, 0.0, 234.4039435813954,
				266.33088304372257, 0.0, 0.0, 1.0 };
		...
		double[] distMatrixData = new double[] { -0.04837465365620614, 0.0026450354779336965, -0.00479882203273576,
				0.0011053843631062754 };
