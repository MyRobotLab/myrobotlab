...
public final class FindFile { // implements FilenameFilter
	 ...
	 * Boolean recurse = true; private Boolean includeDirsInResult = false; private
	...
	public static List<File> find(String root, String criteria, boolean recurse, boolean includeDirsInResult)
	...
	public static List<File> findByExtension(String root, String extensions, boolean recurse)
			throws FileNotFoundException {
	...
	private static List<File> process(File rootPath, String criteria, boolean recurse, boolean includeDirsInResult,
			boolean dirsOnly) throws FileNotFoundException {
		...
		for (File file : filesDirs) {
			...
			if (matcher.find()) {
				out.append(" matches");
				if ((!dirsOnly && file.isFile()) || (dirsOnly && file.isDirectory())
						|| (!file.isFile() && includeDirsInResult)) {
