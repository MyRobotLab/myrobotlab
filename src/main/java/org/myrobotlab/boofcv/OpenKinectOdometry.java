...
public class OpenKinectOdometry {
	...
	private void initOdometry(CameraPinholeRadial param) {
		...
		visualOdometry = FactoryVisualOdometry.depthDepthPnP(1.5, 120, 2, 200, 50, true, sparseDepth, tracker,
	...
	private void processOdometry() {
		...
		for (int i = 0; i < points.size(); i++) {
			...
			Point3D_F64 pFixed = new Point3D_F64(pointMatOut.get(0, 0) / pointMatOut.get(3, 0),
					pointMatOut.get(1, 0) / pointMatOut.get(3, 0), pointMatOut.get(2, 0) / pointMatOut.get(3, 0));
