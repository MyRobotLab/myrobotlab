...
public class OpenKinectOdometry {
    ...
    Log.info("Points size() 2", points.size(), "\n");
		for( int i = 0; i < points.size(); i++ ) {
		    ...
		    // Log.info("Points in ", pointMatIn.get(0, 0), " ", pointMatIn.get(1, 0), " ", pointMatIn.get(2, 0), " ", pointMatIn.get(3, 0));
	        transform.perform();
	        // Log.info("Points out ", pointMatOut.get(0, 0), " ", pointMatOut.get(1, 0), " ", pointMatOut.get(2, 0), " ", pointMatOut.get(3, 0));
		    Point3D_F64 pFixed = new Point3D_F64(pointMatOut.get(0,0) / pointMatOut.get(3,0),
		    		                             pointMatOut.get(1,0) / pointMatOut.get(3,0),          
