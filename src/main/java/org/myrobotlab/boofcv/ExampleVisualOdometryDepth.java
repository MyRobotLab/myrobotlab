...
public class ExampleVisualOdometryDepth {
	...
	public void process() {
		...
		DepthVisualOdometry<GrayU8, GrayU16> visualOdometry = FactoryVisualOdometry.depthDepthPnP(1.5, 120, 2, 200, 50,
				true, sparseDepth, tracker, GrayU8.class, GrayU16.class);
		...
		SimpleImageSequence<GrayU8> videoVisual = media.openVideo(directory + "/" + "rgb.mjpeg",
				ImageType.single(GrayU8.class));
		SimpleImageSequence<GrayU16> videoDepth = media.openVideo(directory + "/" + "depth.mpng",
