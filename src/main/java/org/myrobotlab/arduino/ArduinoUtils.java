...
public class ArduinoUtils {
	...
	/**
	 * Upload the MrlComm.ino sketch to the using an arduino IDE (only version 1.6.8
	 * has been tested for this method.)
	 * 
	 * @param port        the com port (COM4, /dev/ttyAMA0 ...)
	 * @param boardKey    - the board type mega / uno
	 * @param arduinoPath - path to the arduino ide installation
	 * @return true if successful, false otherwise
	 * @throws IOException          - if there's a problem reading the source ino
	 *                              sketch or talking to the com port
	 * @throws InterruptedException - if interrupted.
	 */
	public static boolean uploadSketch(String port, String boardKey, String arduinoPath)
