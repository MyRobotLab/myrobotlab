...
public class MrlCommIno {
	 ...
	 *          back data. Refactoring has made MRLComm.c far more general there are
	 *          only 2 "types" of things - controllers and pins - or writers and
	 *          readers each now will have sub-types
	 *
	 *          Controllers ----------------- digital pins, pwm, pwm/dir dc motors,
	 *          pwm/pwm dc motors
	 *
	 *          Sensors ----------------- digital polling pins, analog polling pins,
	 *          range pins, oscope, trigger events
	 *
	 ...
	 *          getBoardInfo() - returns board info ! TODO - getPinInfo() - returns
	 *          pin info ! TODO - implement with std::vector vs linked list -
	...
	/**
	 * STANDARD ARDUINO LOOP BEGIN This method will be called over and over again by
	 * the arduino, it is the main loop any arduino sketch runs
	 * 
	 * @throws Exception - error if processing of a command blows up for some
	 *                   reason.
	 */
