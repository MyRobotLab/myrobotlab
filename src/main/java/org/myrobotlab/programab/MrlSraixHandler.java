...
public class MrlSraixHandler implements SraixHandler {
	...
	Pattern oobPattern = Pattern.compile("<oob>.*?</oob>",
			Pattern.CASE_INSENSITIVE | Pattern.DOTALL | Pattern.MULTILINE);
	Pattern mrlPattern = Pattern.compile("<mrl>.*?</mrl>",
			Pattern.CASE_INSENSITIVE | Pattern.DOTALL | Pattern.MULTILINE);

	@Override
	public String sraix(Chat chatSession, String input, String defaultResponse, String hint, String host, String botid,
			String apiKey, String limit, Locale locale) {
