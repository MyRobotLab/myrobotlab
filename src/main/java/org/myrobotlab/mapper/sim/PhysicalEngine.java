...
public class PhysicalEngine {
	 ...
	 * Complexity is O(n^2).
	 */
	protected void checkAgentAgentPairs(double dt, ArrayList<SimpleAgent> agents, boolean computeImpact,
	 ...
	 * collision.
	 */
	protected void checkAgentObjectPairs(ArrayList<SimpleAgent> agents, ArrayList<Object> objects,
