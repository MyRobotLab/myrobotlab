...
public class CollisionDectection {
  ...
  public synchronized CollisionResults runTest() {
    ...
    for (CollisionItem item : items.values()) {
      ...
      for (CollisionItem citem : items.values()) {
        ...
        // and vectT2[0] + vectT2[1]*t + vectT2[2]*k = 0) we need to know value
        // of t and k
        ...
        // tk[1], par1[1][0] + par1[1][1]*tk[0] + par1[1][2] * tk[1], par1[2][0]
        // + par1[2][1]*tk[0] + par1[2][2] * tk[1], 0, 0, 0);
        // //get the intersection point between Vt and V2;
        // Point point2 = new Point(par2[0][0] + par2[0][1]*tk[0] + par2[0][2] *
        // tk[1], par2[1][0] + par2[1][1]*tk[0] + par2[1][2] * tk[1], par2[2][0]
        // + par2[2][1]*tk[0] + par2[2][2] * tk[1], 0, 0, 0);
  ...
  public Point[] getClosestPoint(CollisionItem item, CollisionItem citem, Double[] tk, Double[] vector) {
    ...
    // vectT2[0] + vectT2[1]*t + vectT2[2]*k = 0) we need to know value of t and
    // k
    double[] tTemp = new double[3];
    tTemp[0] = vectT1[0] / (vectT1[1] * -1);
    tTemp[2] = vectT1[2] / (vectT1[1] * -1);
    ...
    // get the intersection point between Vt and V1;
    retval[0] = new Point(par1[0][0] + par1[0][1] * tk[0] + par1[0][2] * tk[1], par1[1][0] + par1[1][1] * tk[0] + par1[1][2] * tk[1],
        par1[2][0] + par1[2][1] * tk[0] + par1[2][2] * tk[1], 0, 0, 0);
    // get the intersection point between Vt and V2;
    retval[1] = new Point(par2[0][0] + par2[0][1] * tk[0] + par2[0][2] * tk[1], par2[1][0] + par2[1][1] * tk[0] + par2[1][2] * tk[1],
        par2[2][0] + par2[2][1] * tk[0] + par2[2][2] * tk[1], 0, 0, 0);
    // calculate the distance between these two points
    return retval;
  }
