...
public class Point implements Serializable {
	...
	public Point subtract(Point p) {
		// TODO Auto-generated method stub
		Point newPoint = new Point(x - p.getX(), y - p.getY(), z - p.getZ(), roll - p.getRoll(), pitch - p.getPitch(),
				yaw - p.getYaw());
		return newPoint;
	}
	...
	public String toString() {
		...
		return "(x=" + formatter.format(x) + ", y=" + formatter.format(y) + ", z=" + formatter.format(z) + ", roll="
				+ formatter.format(roll) + ", pitch=" + formatter.format(pitch) + ", yaw=" + formatter.format(yaw)
				+ ")";
	}
