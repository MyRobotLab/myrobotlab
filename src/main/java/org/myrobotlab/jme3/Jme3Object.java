...
public class Jme3Object {
	...
	public Jme3Object(Jme3App jme, String name, String parentName, Service service, Node node, Mapper mapper,
			Vector3f rotationMask, Float currentAngle, Spatial spatial) {
		this.node = node;
		this.mapper = mapper;
	...
	public Jme3Object(JMonkeyEngine jme, String name, String parentName, String assetPath, Mapper mapper,
			Vector3f rotationMask, Vector3f localTranslation, double currentAngle) {
		this.jme = jme;
		this.name = name;
		this.rotationMask = rotationMask;
