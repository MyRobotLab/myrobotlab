...
public class InMoov3DApp extends SimpleApplication implements IntegratedMovementInterface {
	...
	public void simpleInitApp() {
		...
		for (int i = 0; i <= 100; i += 20) {
			...
			battery[i].setLocalTranslation(
					Math.round(settings.getWidth() - (textureBat[i].getImage().getWidth() / widthCoef)),
	 ...
	 * 
	 * @param rotationMask : set Vector3f.UNIT_X, Vector3f.UNIT_Y, Vector3f.UNIT_Z)
	 * for the axe of rotation
	 * 
