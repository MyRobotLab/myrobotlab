...
public class InMoov3DApp extends SimpleApplication implements IntegratedMovementInterface {
  ...
  public void simpleInitApp() {
    ...
    Texture2D textureBackGround = (Texture2D) assetManager.loadTexture(Util.getRessourceDir() + "/InMoov/monitor/monitor_back.png");
    Picture BackGround = new Picture(Util.getRessourceDir() + "/InMoov/monitor/monitor_back.png");
    ...
    Texture2D texture = (Texture2D) assetManager.loadTexture(Util.getRessourceDir() + "/InMoov/monitor/microOn.png");
    microOn = new Picture(Util.getRessourceDir() + "/InMoov/monitor/microOn.png");
    ...
    Texture2D textureOff = (Texture2D) assetManager.loadTexture(Util.getRessourceDir() + "/InMoov/monitor/microOff.png");
    microOff = new Picture(Util.getRessourceDir() + "/InMoov/monitor/microOff.png");
    ...
    for (int i = 0; i <= 100; i += 20) {
      textureBat[i] = (Texture2D) assetManager.loadTexture(Util.getRessourceDir() + "/InMoov/monitor/bat_" + i + ".png");
      battery[i] = new Picture(Util.getRessourceDir() + "/InMoov/monitor/bat_" + i + ".png");
