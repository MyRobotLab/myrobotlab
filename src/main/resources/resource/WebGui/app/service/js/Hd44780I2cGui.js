angular.module('mrlapp.service.Hd44780I2cGui', [])
.controller('Hd44780I2cGuiCtrl', ['$scope', '$log', 'mrl', '$uibModal', '$sce', function($scope, $log, mrl, $uibModal, $sce) { // $modal ????
    $log.info('Hd44780I2cGuiCtrl');
