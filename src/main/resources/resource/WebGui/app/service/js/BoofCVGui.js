angular.module('mrlapp.service.BoofCVGui', []).controller('BoofCVGuiCtrl', ['$scope', 'mrl', '$uibModal', function($scope, mrl, $uibModal) {
    console.info('BoofCVGuiCtrl')
    // grab a reference
    var _self = this
    // grab the message
    var msg = this.msg
     ...
     * in BoofCV.html - you can find were these are used when getFilterType() is called
     */
    ...
    if ($scope.service.capturing) {
        ...
        $scope.imgSource = "service/img/BoofCV.png"
    }

    // Handle an update state call from BoofCV service.
