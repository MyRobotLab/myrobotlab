angular.module('mrlapp.service.TemplateGui', []).controller('TemplateGuiCtrl', ['$scope', '$log', 'mrl', '$timeout', function($scope, $log, mrl, $timeout) {
        ...
        me1: {
            sizes: {
                ...
                tiny: {
                    ...
                    //define a glyphicon to show (as a symbol)
                    width: 200,
            ...
            //shows your size-options in _self order
