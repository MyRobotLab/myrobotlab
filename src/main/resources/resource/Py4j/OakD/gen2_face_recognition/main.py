...
with open(os.path.join(current_dir, "script.py"), "r") as f:
...
print("HHHHHHHHHHHHHHHHHHHHHHELLLOOOO!!!!")

# from OakD.gen2_face_recognition import main

with dai.Device(pipeline) as device:
    facerec = FaceRecognition(databases, "grog")
                ...
                try:
                    ...
                    if elapsed_time > 1:
                        classification = {
                            ...
                            "bbox": None,
                            "src": None,
                            "class": "org.myrobotlab.service.data.Classification",
                        }
                        json_data = f"[{json.dumps(classification)}]"

                        # URL of the endpoint
                        # url = "http://localhost:8888/api/service/i01/onClassification"
                        url = "http://localhost:8888/api/service/oak/publishClassification"
