...
public class GPS extends Service implements SerialDataListener {
	 ...
	 * the examples on the following blog
	 * http://stefanbangels.blogspot.be/2012/12
	 ...
	 * only 0-14 elements. GGA Global Positioning System Fixed Data GLL
	 * Geographic Position - Latitude/Longitude GSV GNSS Satellites in View RMC
	 * Recommended Minimum Specific GNSS Data VTG Course Over Ground and Ground
	 * Speed GSA GNSS DOP and Active Satellites MSS MSK Receiver Signal kmc - so
	 * the data you have doesn't have two (GLL and MSK)
	 * 
	 * @return
	 */
