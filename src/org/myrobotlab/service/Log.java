...
// FIXME - setLevel - addAppender(ssl smtp other...) logWatcher
/**
 * 
...
public class Log extends Service implements Appender<ILoggingEvent>, NameProvider, CommunicationInterface {
  ...
  public Log(String n) {
    super(n);
    // cm = this; Nope .. you don't want to do this
  }
  ...
  public void startService() {
     ...
     * logger..getAppender("file"); if(fileAppender != null) {
     * fileAppender.stop(); fileAppender.setFile("new.log"); PatternLayout pl =
     * new PatternLayout(); pl.setPattern("%d %5p %t [%c:%L] %m%n)");
  ...
  public void doAppend(ILoggingEvent arg0) throws LogbackException {
    Message msg = createMessage("", "onLogEvent", new Object[] { String.format("[%s] %s", arg0.getThreadName(), arg0.toString()) });
