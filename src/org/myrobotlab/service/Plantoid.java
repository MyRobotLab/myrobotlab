...
public class Plantoid extends Service {
  ...
  // Imaged from there should be taken and put through the infrapix, then opencv
   ...
   * 
   * @param power
   *          power range is from -90 (spin full clock wise) 0 (stop) 90 (spin
  ...
  /**
   * square dance "should" make a square by moving the plantoid up and down the
   * X and Y axis's
   * 
   * @param power
  ...
  /**
   * This begins polling of the various analog senesors of the Plantoid server.
   * It is automatically started when the Plantoid service is started. Soil,
   * temperature, left and right light sensors and air quality are all polled
   */
