...
public class WebGui extends Service implements AuthorizationProvider, Gateway, Handler {
  ...
  public void handle(AtmosphereResource r) {
    ...
    try {
       ...
       * LONG_POLLING: event.getResource().resume(); break; case WEBSOCKET: case
       * STREAMING: res.getWriter().flush(); break; }
       */
      ...
      // FIXME - need to take care of this - client does not always send correct
      // length
