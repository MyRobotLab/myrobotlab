...
public class WebGUI2 extends Service implements AuthorizationProvider, Gateway, Handler {

	private static final long serialVersionUID = 1L;

	public final static Logger log = LoggerFactory.getLogger(WebGUI2.class);
	...
	public void handle(AtmosphereResource r) {
		try {
			...
			if (pathInfo != null) {
				trailingCharacter = pathInfo.substring(pathInfo.length() - 1); 
			}
			...
			if ("messages".equals(apiType)){
				...
				// FIXME - parse url & path should be in Encoder
				// decode incoming parameters
				
				//if (parts.length == 3 && !"/".equals(trailingCharacter)){
	...
	*/
	...
	public static void main(String[] args) {
		...
		try {
			...
			WebGUI2 webgui = (WebGUI2) Runtime.start("webgui", "WebGUI2");
