...
//
	...
	public void onJoystickInput(Input input) {
		...
		// input.id
		// input.value 
		// depending on input we want to get the current position and move in some direction. 
		...
		// Ok, so this will track the y,rx,ry inputs from the joystick as x,y,z velocities
		...
		// at some interval and move the current position by the new dx,dy,dz computed based
