...
public class PickToLight extends Service implements GpioPinListenerDigital {
	...
	// "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:tem=\"http://tempuri.org/\"><soapenv:Header/><soapenv:Body><tem:plant>%s</tem:plant><tem:Event><tem:Type>%s</tem:Type><tem:Data>%s</tem:Data></tem:Event></soapenv:Body></soapenv:Envelope>";
	...
	public static void main(String[] args) {
		...
		try {
			...
			/*
			 * int MASK_DISPLAY = 0x01; int MASK_LED = 0x02; int MASK_SENSOR =
			 * 0x80;
			 */
