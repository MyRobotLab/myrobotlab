...
public class Servo extends Service implements ServoControl {
  ...
  public class Sweeper extends Thread {
    ...
    /*
     * int min; int max; int delay; // depending on type - this is 2 different
     * things COMPUTER // its ms delay - CONTROLLER its modulus loop count int
     * step; boolean sweepOneWay;
     */
   ...
   * leave it even on a detach - a attach with pin should only replace it - that
   * way pin does not need to be stored on the Servo
   */
  private Integer pin;
  ...
  public Integer getPin() {
    /*
     * valiant attempt of normalizing - but Servo needs to know its own pin to
     * support attach()
     * 
