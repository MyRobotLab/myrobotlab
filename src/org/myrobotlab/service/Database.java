...
public class Database extends Service {
	...
	String connectionString; // e.g. "jdbc:mysql://HOST/DATABASE"
	String jdbcUser;
	String jdbcPassword;
	...
	public void connect(String uri) throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException {
