...
public class Python extends Service {
  ...
  public void createPythonInterpreter() {
    ...
    if (!FileIO.isJar()) {
      props.put("python.home", "build/classes"); // hmm should be /Lib ./Lib
                                                 // classpath relative path or
                                                 // other ?
   ...
   * file system, which may not be the GUIService's local system. Because it can
