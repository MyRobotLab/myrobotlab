...
public interface MotorController extends NameProvider, MicrocontrollerPeripheral {
	...
	/**
	 * MotorDetach - detach the MotorControl from a specific pin on the
	 * controller
	 * 
	 * @param name
	...
	/**
	 * These symmetric String methods should probably be better suited if this
	 * was an abstract class rather than an interface - then the mundane string
	 * to type methods could be implemented only once
	 * 
	 * @param name
	 * @param portNumber
	 */
