...
public class VirtualArduino extends Service implements SerialDataListener, RecordControl {
  ...
  /**
   * represents actual hardware resource pool to preserve state of the hardware
   */
  ...
  public void publishBoardInfo() {
    ...
    msg.publishBoardInfo(MRLCOMM_VERSION, boardInfo.getBoardType(), (int)avgLoadTimeUs, getFreeRam(), deviceSummary);
  }
