...
public class CodecFactory {
	...
	static public Codec getCodec(String mimeType) throws ClassNotFoundException, NoSuchMethodException, SecurityException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException{
		if (!initialized){
			init();
		}
		String clazz = null;
...
/*	
	static public Codec getCodec(String clazz, Object... params) throws ClassNotFoundException, NoSuchMethodException, SecurityException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException{
		...
		Codec codec = (Codec)constructor.newInstance(params);
		//return new CodecJson();
		return codec;
	}
*/
