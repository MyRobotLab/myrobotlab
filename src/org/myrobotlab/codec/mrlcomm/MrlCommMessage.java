...
public class MrlCommMessage {
  // TODO when an mrl message is received from arduino. cast it to this message class
  ...
  // TODO add a bunch of helper functions that take care of the casting and bit masking
