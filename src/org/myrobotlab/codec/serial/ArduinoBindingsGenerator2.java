...
public class ArduinoBindingsGenerator2 {

	public transient final static Logger log = LoggerFactory.getLogger(ArduinoBindingsGenerator2.class);
	...
	public static void main(String[] args) {
		try {
			...
			ArduinoBindingsGenerator2.generateDefinitions();
