...
public interface PConstants {
	...
	/**
	 * Static usage mode for PShape3D (vertices won't be updated after
	 * creation).
	 */
	public static final int STATIC = 0;
	/**
	 * Dynamic usage mode for PShape3D (vertices will be updated after
	 * creation).
	 */
	public static final int DYNAMIC = 1;

	/**
	 * Elements handled by PShape3D (vertices, normals, color, texture
