...
public final class PMatrix3D /* implements PMatrix3D , PConstants */{
	...
	public void apply(PMatrix3D source) {
		apply(source.m00, source.m01, source.m02, source.m03, source.m10, source.m11, source.m12, source.m13, source.m20, source.m21, source.m22, source.m23, source.m30,
				source.m31, source.m32, source.m33);
	}
	...
	protected void invRotate(float angle, float v0, float v1, float v2) {
		...
		preApply((t * v0 * v0) + c, (t * v0 * v1) - (s * v2), (t * v0 * v2) + (s * v1), 0, (t * v0 * v1) + (s * v2), (t * v1 * v1) + c, (t * v1 * v2) - (s * v0), 0, (t * v0 * v2)
				- (s * v1), (t * v1 * v2) + (s * v0), (t * v2 * v2) + c, 0, 0, 0, 0, 1);
	}
	...
	public PVector mult(PVector source, PVector target) {
		...
		target.set(m00 * source.x + m01 * source.y + m02 * source.z + m03, m10 * source.x + m11 * source.y + m12 * source.z + m13, m20 * source.x + m21 * source.y + m22 * source.z
				+ m23);
	...
	public void print() {
		 ...
		 * PApplet.nfs(m01, digits, 4) + " " + PApplet.nfs(m02, digits, 4) + " "
		 * + PApplet.nfs(m03, digits, 4));
		 * 
		 * System.out.println(PApplet.nfs(m10, digits, 4) + " " +
		 * PApplet.nfs(m11, digits, 4) + " " + PApplet.nfs(m12, digits, 4) + " "
		 * + PApplet.nfs(m13, digits, 4));
		 * 
		 * System.out.println(PApplet.nfs(m20, digits, 4) + " " +
		 * PApplet.nfs(m21, digits, 4) + " " + PApplet.nfs(m22, digits, 4) + " "
	...
	public void rotate(float angle, float v0, float v1, float v2) {
		...
		apply((t * v0 * v0) + c, (t * v0 * v1) - (s * v2), (t * v0 * v2) + (s * v1), 0, (t * v0 * v1) + (s * v2), (t * v1 * v1) + c, (t * v1 * v2) - (s * v0), 0, (t * v0 * v2)
				- (s * v1), (t * v1 * v2) + (s * v0), (t * v2 * v2) + c, 0, 0, 0, 0, 1);
	}
	 ...
	 * formatted[] = new String[num.length]; for (int i = 0; i <
	 * formatted.length; i++) { formatted[i] = nfs(num[i], left, right); }
	 * return formatted; }
	 * 
	 * static public String nfs(float num, int left, int right) { return (num <
	 * 0) ? nf(num, left, right) : (' ' + nf(num, left, right)); }
	 */
