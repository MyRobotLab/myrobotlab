...
/**
 * This stage will rename fields on a document to lowercase them,
 * and replace punctuation with underscores
 * This is useful to make the field names search engine(solr) friendly.
 *
 * @author kwatters
 *
 */
