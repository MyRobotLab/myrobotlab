...
public class SampleListener extends Listener {
	...
	public void onFrame(Controller controller) {
		...
		System.out.println("Frame id: " + frame.id() + ", timestamp: " + frame.timestamp() + ", hands: " + frame.hands().count() + ", fingers: " + frame.fingers().count()
		...
		for (int i = 0; i < gestures.count(); i++) {
			...
			case TYPE_SWIPE:
				...
				System.out.println("  Swipe id: " + swipe.id() + ", " + swipe.state() + ", position: " + swipe.position() + ", direction: " + swipe.direction() + ", speed: "
						+ swipe.speed());
				break;
