 ...
 * 
 */
package org.myrobotlab.maryspeech.util;
 ...
 *
 * @author Marc Schr&ouml;der modified by LunDev
 */
...
public class MaryUtils {
	...
	protected static final char[] punctuationTable = new char[] { 8220, '"', // â€ž
			8222, '"', // â€œ
			8211, '-', // -
			'\u2033', '"', // â€³
			'\u2036', '"', // â€¶
	 ...
	 * GERMAN: ascii plus german umlauts and ÃŸ. For other locales: ascii.
	 * 
	 * @param unicodeText
	...
	protected static final char[] toGermanLetterTable = new char[] { '\u00c0', 'A', // Ã€
			'\u00c1', 'A', // Ã�
			'\u00c2', 'A', // Ã‚
			'\u00c3', 'A', // 
			'\u00c5', 'A', // Ã…
