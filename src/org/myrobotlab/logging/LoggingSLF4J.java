...
public class LoggingSLF4J extends Logging {
	...
	public String getLevel() {
		 ...
		 * context=(LoggerContext)LoggerFactory.getILoggerFactory(); for (
		 * Logger logger : context.getLoggerList()) { if (logger.getLevel() !=
		 * null) { levels.put(logger.getName(),logger.getLevel().toString()); }
		 * }
		 */
