...
public class Sizer implements MessageConsumer {
	...
	public long computeSize() throws RunnerException {
		...
		try {
			...
			// The default Throwable.toString() never returns null, but
			// apparently
			// some sub-class has overridden it to do so, thus we need to check
			// for
			// it. See:
			// http://www.arduino.cc/cgi-bin/yabb2/YaBB.pl?num=1166589459
			exception = new RunnerException((e.toString() == null) ? e.getClass().getName() + r : e.toString() + r);
		}
