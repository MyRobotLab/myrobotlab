...
public class IntegratedMovementGUI extends ServiceGUI implements ActionListener {
  ...
  public void attachGUI() {
    subscribe("publishState", "getState", IntegratedMovement.class);
    send("publishState");
  }

  @Override
  public void detachGUI() {
    unsubscribe("publishState", "getState", IntegratedMovement.class);
  }

  public void getState(IntegratedMovement im) {
