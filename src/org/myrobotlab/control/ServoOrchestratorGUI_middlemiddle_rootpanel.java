...
public class ServoOrchestratorGUI_middlemiddle_rootpanel extends JPanel {
    ...
    ServoOrchestratorGUI_middlemiddle_rootpanel(ServoOrchestratorGUI_middlemiddle_main demo) {
        ...
        this.setDropTarget(new DropTarget(ServoOrchestratorGUI_middlemiddle_rootpanel.this, new ServoOrchestratorGUI_middlemiddle_droptargetlistener(ServoOrchestratorGUI_middlemiddle_rootpanel.this)));
    }
