...
public class MyoThalmicGUI extends ServiceGUI implements ActionListener {
	...
	public final static Logger log = LoggerFactory.getLogger(MyoThalmicGUI.class.getCanonicalName());

	public MyoThalmicGUI(final String boundServiceName, final GUIService myService, final JTabbedPane tabs) {
	...
	public void getState(MyoThalmic template) {
