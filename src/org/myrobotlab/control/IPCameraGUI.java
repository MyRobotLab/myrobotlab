...
public class IPCameraGUI extends ServiceGUI implements ListSelectionListener {
	...
	/*
	 * JTextField host = new JTextField("192.168.0.68", 8); JTextField user =
	 * new JTextField("admin", 8); JPasswordField password = new
	...
	public void init() {
		...
		/*
		 * ++gc.gridy; display.add(capture, gc); ++gc.gridy; display.add(info,
		 * gc);
		 */
	}

	/**
	 * JUST STREAM THE #*%(%(*# VIDEO ! The return of IPCamera.getStatus which
	 * is used to test connectivity
	 * 
	 * @param s
	 */
	/*
