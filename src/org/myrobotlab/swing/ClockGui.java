...
public class ClockGui extends ServiceGui implements ActionListener {
  ...
  public void subscribeGui() {
    ...
    subscribe("publishState", "onState", Clock.class);
  ...
  public void countdown(Long amtRemaining, String pulseData) {
    ...
    // color:#2BFF00;
    // msgDisplay.setText("<html><p
    // style=\"font-size:10px;text-align:center;\">until core meltdown<br/>have
    // a nice day !</p></html>");
    msgDisplay.setText("");
  ...
  public void unsubscribeGui() {
    ...
    unsubscribe("publishState", "onState", Clock.class);
