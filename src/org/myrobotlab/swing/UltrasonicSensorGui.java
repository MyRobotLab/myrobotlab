...
public class UltrasonicSensorGui extends ServiceGui implements ActionListener {
  ...
  public UltrasonicSensorGui(final String boundServiceName, final Swing myService, final JTabbedPane tabs) {
  ...
  public void subscribeGui() {
    ...
    subscribe("publishRange", "onRange", Double.class);
    subscribe("publishState", "onState", UltrasonicSensor.class);
